...
// function FarmatFilms(films = []){
// console.log(films.img);
...
//     console.log(films[i].img, 'uasidhiuas ') ;
//    div.innerHTML = `

//       <img src='${films[i].img}' class="card-img-top" alt="...">
//     <div class="card-body">
//     <h5 class="card-title">${films[i].name}</h5>
//     <p class="card-text">${films[i].name}...</p>
    
//     <h3>${films[i].name}</h3>
//     <h4>Year: ${films[i].name}</h4>
//     <a href="#" class="btn btn-primary">Go somewhere</a>
//   </div>
//   `
//   }
//   console.log(div, 'kasdas');
//   document.body.appendChild(div)

// }
// FarmatFilms(pokemons)
